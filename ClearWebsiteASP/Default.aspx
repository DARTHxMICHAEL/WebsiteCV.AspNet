<%@ Page Title=".WebDeveloper" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="_Default" %>
...
<body>
          ...
          <div class="container">
            ...
            <div class="row">
              <div class="col-sm-6 col-md-4 text-center about-us-hover" data-aos="zoom-in" data-aos-delay="100">
                ...
                <p class="about-us-card-text">Urodziłem się w 1999 roku, mieszkam w Skawinie. Szukam pracy/stażu na pół etatu przy tworzeniu stron-aplikacji internetowych (full stack web developer). Lubię pracę z ludźmi i nie boję się nowych wyzwań.</p>
              </div>
              <div class="col-sm-6 col-md-4 text-center about-us-hover" data-aos="zoom-in" data-aos-delay="200">
                ...
                <p class="about-us-card-text">Platforma ASP.NET. Język C#, HTML, CSS, SQL i C++. Środowisko Visual Studio, Unity Adobe (Ps2019) oraz ArcGIS Pro. Nauczone z pomocą kursów internetowych (m.in. W3Schools) oraz studiów. Aktywny użytkownik StackOverflow i GitHuba.</p>
              </div>
              ...
              <div class="col-sm-6 col-md-4 text-center about-us-hover" data-aos="zoom-in" data-aos-delay="500">
                ...
                <p class="about-us-card-text"><span class="blue-text">Geografia fak. Systemy Informacji Geograficznej, Uniwersytet Jagielloński (2020-obecnie)</span><br/>Interdyscyplinarne studia. Wiedza z zakresu zarządzania, geografii fizycznej oraz technologii. Przedmioty matematyczne oraz informatyczne.</p>
                <p class="about-us-card-text"><span class="blue-text">Informatyka na FAIS, Uniwersytet Jagielloński (2018-2020)</span><br/>Studia informatyczne, dużo matematyki (wszystkie przedmioty zaliczone). Wstrzymane po czwartym semestrze. Po skończeniu geografii planuję powrót i ukończenie licencjatu, albo przejście na 2 stopień.</p>
              ...
              <div class="col-sm-6 col-md-4 text-center about-us-hover" data-aos="zoom-in" data-aos-delay="400">
                ...
                <p class="about-us-card-text"><span class="blue-text">Sprzedawca w sklepie spożyczym (2020)</span><br/>Praca w wielobranżowym sklepie spożywczym. Głównie w charakterze sprzedawcy oraz jako pomoc przy logistyce. Praca na pół etatu.</p>
              </div>
            </div>
          </div>
        </section>
          ...
          <div class="container">
            ...
            <div class="price-wrap row text-center justify-content-center">
              <div class="col-md-6 col-xl-8" data-aos="flip-right" data-aos-delay="400">
                <div class="price-box" style="height: 560px;">
              ...
              <div class="col-md-6 col-xl-8" data-aos="flip-right" data-aos-delay="400">
                <div class="price-box" style="height: 690px;">
    ...
    <script>
          ...
          <div class="container">
            ...
            <div class="price-wrap row text-center justify-content-center">
              <div class="col-md-6 col-xl-8" data-aos="flip-right" data-aos-delay="200">
                <div class="price-box" style="height: 610px; background-image: linear-gradient(45deg, #ffffff 25%, #536b70 25%, #536b70 50%, #ffffff 50%, #ffffff 75%, #536b70 75%, #536b70 100%); background-size: 56.57px 56.57px;">
                  <h3 class="change-margin">Formularz kontaktowy</h3>
                  <hr>
                      <div class="row">
                        <div class="col-md-6">
                          <p>Treść wiadomości</p><asp:TextBox ID="TextBoxWiad" runat="server" Height="280px" Width="300px" BackColor="white" BorderWidth="1px" TextMode="MultiLine" Text="    formularz chwilowo nieczynny"></asp:TextBox><br>
                           <p>Dane kontaktowe</p><asp:TextBox ID="TextBoxKont" runat="server" Height="20px" Width="150px" BackColor="white" BorderWidth="1px"></asp:TextBox><br><br>
                          <button class="btn btn-secondary" >Wyślij</button>
                        </div>
                        <div class="col-md-6 justify-content-start" style="align-items: flex-start">
                          <br/><br/><br/><br/> <p>Formularz chwilowo nieczynny ze względu na zmianę serwera SMTP. Z obecnym pojawiły się problemy na poziomie autoryzacji...</p>
                        </div>
                      </div>
                </div>
              </div>
        ...
        <footer class="bg-dark text-light py-4 text-center">
          <p class="mb-0"> 2022 &copy; .Net WebDeveloper </p>
        </footer>
